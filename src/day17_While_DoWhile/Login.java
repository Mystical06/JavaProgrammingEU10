...
public class Login {
    public static void main(String[] args) {
        ...
        if (usrnme.equals(username) && psswrd.equals(password) ){
            System.out.println("Logged in");
        }

        int attempt=3;

        while (!(usrnme.equals(username) && psswrd.equals(password)) && attempt>0){//while the credentials are invalid and user has attempts
            if (attempt==1){
